...
object ExerciseLibrary {
    ...
    val entries: List<ExerciseEntry> = listOf(
        ...
        ExerciseEntry("smith_split_squat", "Smith Machine Split Squat", SINGLE_LEG, listOf(MACHINE), false, flat(95.0), 10, shortName = "Smith Split"),
        ...
        ExerciseEntry("standing_leg_curl", "Standing Single-Leg Curl", KNEE_FLEXION, listOf(MACHINE), false, flat(45.0), 5, shortName = "Single-Leg Curl"),
        ...
        ExerciseEntry("incline_db", "Incline DB Press", H_PUSH, listOf(DUMBBELL, BENCH), true, std(INCLINE), 3, shortName = "Incline DB"),
        ...
        ExerciseEntry("machine_chest", "Machine Chest Press", H_PUSH, listOf(MACHINE), false, flat(100.0), 5, shortName = "Chest Press"),
        ...
        ExerciseEntry("ohp", "Overhead Press (Barbell)", V_PUSH, listOf(BARBELL, RACK), false, std(OHP), 1, shortName = "OHP"),
        ExerciseEntry("db_shoulder", "Seated DB Shoulder Press", V_PUSH, listOf(DUMBBELL, BENCH), true, flat(55.0), 2, shortName = "Seated DB OHP"),
        ExerciseEntry("machine_shoulder", "Machine Shoulder Press", V_PUSH, listOf(MACHINE), false, flat(90.0), 3, shortName = "Shoulder Press"),
        ...
        ExerciseEntry("standing_db_press", "Standing DB Press", V_PUSH, listOf(DUMBBELL), true, flat(50.0), 7, shortName = "Standing DB OHP"),
        ...
        ExerciseEntry("smith_shoulder", "Smith Machine Shoulder Press", V_PUSH, listOf(MACHINE, BENCH), false, frac(0.85, OHP), 10, shortName = "Smith Shoulder"),
        ...
        ExerciseEntry("hspu", "Handstand Push-Up", V_PUSH, listOf(BODYWEIGHT), false, reps(5), 13, shortName = "HSPU"),

        ExerciseEntry("bb_row", "Barbell Row", H_PULL, listOf(BARBELL), false, std(ROW), 1),
        ExerciseEntry("cs_row", "Chest-Supported Row", H_PULL, listOf(MACHINE), false, frac(0.8, STD_BENCH), 2, shortName = "Chest Row"),
        ...
        ExerciseEntry("db_cs_row", "Chest-Supported DB Row", H_PULL, listOf(DUMBBELL, BENCH), true, flat(50.0), 7, shortName = "Chest DB Row"),
        ...
        ExerciseEntry("single_cable_row", "Single-Arm Cable Row", H_PULL, listOf(CABLE), false, flat(60.0), 10, shortName = "Single-Arm Row"),
        ...
        ExerciseEntry("single_arm_pulldown", "Single-Arm Cable Pulldown", V_PULL, listOf(CABLE), false, flat(50.0), 7, shortName = "1-Arm Pulldown"),
        ExerciseEntry("straight_arm_pd", "Straight-Arm Pulldown", V_PULL, listOf(CABLE), false, flat(45.0), 8, shortName = "Straight-Arm"),
        ...
        ExerciseEntry("seated_db_lateral", "Seated DB Lateral Raise", SIDE_DELT, listOf(DUMBBELL, BENCH), true, flat(15.0), 4, shortName = "Seated Lateral"),
        ExerciseEntry("lean_away_lateral", "Lean-Away Cable Lateral", SIDE_DELT, listOf(CABLE), false, flat(12.5), 5, shortName = "Lean-Away Raise"),
        ...
        ExerciseEntry("cs_reverse_fly", "Chest-Supported Reverse Fly", REAR_DELT, listOf(DUMBBELL, BENCH), true, flat(15.0), 3, shortName = "Chest Rear Fly"),
        ...
        ExerciseEntry("rear_delt_row", "DB Rear-Delt Row", REAR_DELT, listOf(DUMBBELL), true, flat(35.0), 6, shortName = "Rear-Delt Row"),
        ...
        ExerciseEntry("rope_hammer_curl", "Rope Hammer Curl", BICEPS, listOf(CABLE), false, flat(50.0), 8, shortName = "Rope Hammer"),
        ...
        ExerciseEntry("oh_tri_ext", "Cable Overhead Triceps Extension", TRICEPS, listOf(CABLE), false, flat(50.0), 2, shortName = "Overhead Ext"),
        ...
        ExerciseEntry("machine_tri_ext", "Machine Triceps Extension", TRICEPS, listOf(MACHINE), false, flat(70.0), 8, shortName = "Machine Tri Ext"),
        ...
        ExerciseEntry("bw_calf_raise", "Single-Leg Calf Raise", CALF_GASTROC, listOf(BODYWEIGHT), false, reps(15), 6, weightedPairId = "db_calf", shortName = "Single-Leg Calf"),
