...
- **Standalone Cardio+Core days — landed.** SEPARATE_DAYS/BOTH output is stored
  as CARDIO program-day rows, offered quietly from Today, and kept outside the
  strength rotation and day tabs.
