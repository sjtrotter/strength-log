...
data class TodayWidgetContent(
    ...
    /** Day index for [io.github.sjtrotter.strengthlog.domain.theme.DayAccentColors]; 0 when there's no day. */
    val accentIndex: Int,
    val setsDone: Int,
    val totalSets: Int,
)
...
/**
 * Projects the shared today-state ([io.github.sjtrotter.strengthlog.sync.TodaySnapshotSource])
