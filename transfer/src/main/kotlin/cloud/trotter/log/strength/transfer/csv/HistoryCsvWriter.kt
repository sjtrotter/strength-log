 ...
 * Android-free — [cloud.trotter.log.strength.transfer.csv.CsvHistoryService]
 * supplies the data from [cloud.trotter.log.strength.data.TrackerRepository.exportSessionHistory].
 *
