...
class ExerciseCatalogTest {
    ...
    fun `custom ids never collide and never shadow a catalog entry`() {
        ...
        assertEquals(GoalSource.Std(cloud.trotter.log.strength.domain.model.StandardLift.SQUAT),
    ...
    fun `the mapper parses pattern and equipment enum names`() {
        ...
        assertEquals(
            listOf(
                cloud.trotter.log.strength.domain.model.Equipment.MACHINE,
                cloud.trotter.log.strength.domain.model.Equipment.CABLE,
            ),
            entry.equipment,
        )
