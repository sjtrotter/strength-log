 ...
 * lives in `:domain`, mirrors [cloud.trotter.log.strength.ui.day.DayViewModel]).
 *
 ...
 * blank/whitespace name can never reach [cloud.trotter.log.strength.data.TrackerRepository.addCustomExercise].
 */
 ...
 *  [cloud.trotter.log.strength.ui.wizard.WizardActions]. */
